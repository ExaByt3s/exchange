...
class UsersTableMap extends TableMap
{
     ...
     */
    const COL_WALLET_ID = 'users.wallet_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Login', 'Email', 'Firstname', 'Surname', 'Password', 'WalletId', 'Status', ),
        self::TYPE_CAMELNAME     => array('id', 'login', 'email', 'firstname', 'surname', 'password', 'walletId', 'status', ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID, UsersTableMap::COL_LOGIN, UsersTableMap::COL_EMAIL, UsersTableMap::COL_FIRSTNAME, UsersTableMap::COL_SURNAME, UsersTableMap::COL_PASSWORD, UsersTableMap::COL_WALLET_ID, UsersTableMap::COL_STATUS, ),
        self::TYPE_FIELDNAME     => array('id', 'login', 'email', 'firstname', 'surname', 'password', 'wallet_id', 'status', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Login' => 1, 'Email' => 2, 'Firstname' => 3, 'Surname' => 4, 'Password' => 5, 'WalletId' => 6, 'Status' => 7, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'login' => 1, 'email' => 2, 'firstname' => 3, 'surname' => 4, 'password' => 5, 'walletId' => 6, 'status' => 7, ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID => 0, UsersTableMap::COL_LOGIN => 1, UsersTableMap::COL_EMAIL => 2, UsersTableMap::COL_FIRSTNAME => 3, UsersTableMap::COL_SURNAME => 4, UsersTableMap::COL_PASSWORD => 5, UsersTableMap::COL_WALLET_ID => 6, UsersTableMap::COL_STATUS => 7, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'login' => 1, 'email' => 2, 'firstname' => 3, 'surname' => 4, 'password' => 5, 'wallet_id' => 6, 'status' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('surname', 'Surname', 'VARCHAR', false, 64, null);
        $this->addColumn('password', 'Password', 'VARCHAR', true, 64, null);
        $this->addForeignKey('wallet_id', 'WalletId', 'INTEGER', 'wallets', 'id', true, null, null);
        $this->addColumn('status', 'Status', 'VARCHAR', true, 1, '0');
    } // initialize()
    ...
    {
        $this->addRelation('Wallets', '\\Wallets', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':wallet_id',
    1 => ':id',
        ...
        $this->addRelation('Tokens', '\\Tokens', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':user_id',
    1 => ':id',
  ),
), null, null, 'Tokenss', false);
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsersTableMap::COL_LOGIN);
            ...
            $criteria->addSelectColumn(UsersTableMap::COL_WALLET_ID);
