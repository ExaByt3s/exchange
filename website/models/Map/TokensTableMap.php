...
class TokensTableMap extends TableMap
{
     ...
     */
    const COL_ID = 'tokens.id';

    /**
     * the column name for the user_id field
     */
    const COL_USER_ID = 'tokens.user_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'UserId', 'Type', 'Value', ),
        self::TYPE_CAMELNAME     => array('id', 'userId', 'type', 'value', ),
        self::TYPE_COLNAME       => array(TokensTableMap::COL_ID, TokensTableMap::COL_USER_ID, TokensTableMap::COL_TYPE, TokensTableMap::COL_VALUE, ),
        self::TYPE_FIELDNAME     => array('id', 'user_id', 'type', 'value', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'UserId' => 1, 'Type' => 2, 'Value' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'userId' => 1, 'type' => 2, 'value' => 3, ),
        self::TYPE_COLNAME       => array(TokensTableMap::COL_ID => 0, TokensTableMap::COL_USER_ID => 1, TokensTableMap::COL_TYPE => 2, TokensTableMap::COL_VALUE => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'user_id' => 1, 'type' => 2, 'value' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setPrimaryKeyMethodInfo('tokens_id_seq');
        // columns
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(TokensTableMap::COL_ID);
            $criteria->addSelectColumn(TokensTableMap::COL_USER_ID);
            $criteria->addSelectColumn(TokensTableMap::COL_TYPE);
            $criteria->addSelectColumn(TokensTableMap::COL_VALUE);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(TokensTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(TokensTableMap::COL_ID) && $criteria->keyContainsValue(TokensTableMap::COL_ID) ) {
